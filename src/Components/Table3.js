...
const Table3 = () => {
    ...
    function createData( D, V, B, S, Ds, A ) {
        return { D, V, B, S, Ds, A };
      }
      
      const rows = [
        createData('23/08/2023', 'UP 13 AC 1543', '#70178KT', '332, Kucha Ghasi Ram', 'Lorem Ipsum', 2500),
        createData('23/08/2023', 'UP 13 AC 1543', '#70178KT', '332, Kucha Ghasi Ram', 'Lorem Ipsum', 2500),
        createData('23/08/2023', 'UP 13 AC 1543', '#70178KT', '332, Kucha Ghasi Ram', 'Lorem Ipsum', 2500),
        createData('23/08/2023', 'UP 13 AC 1543', '#70178KT', '332, Kucha Ghasi Ram', 'Lorem Ipsum', 2500),
        createData('23/08/2023', 'UP 13 AC 1543', '#70178KT', '332, Kucha Ghasi Ram', 'Lorem Ipsum', 2500),
               ...
               <Table sx={{ minWidth: 650, borderCollapse:'separate', borderSpacing:'0 10px' }} size="small" aria-label="a dense table">
                 <TableHead>
                   <TableRow component={Paper} sx={{bgcolor:'#0155A5'}}>
                     ...
                     <TableCell align='center' sx={{fontWeight:700, color:'white', py:1.5}}>Description</TableCell>
                     <TableCell align='center' sx={{fontWeight:700, color:'white', py:1.5}}>Amount (in Rs)</TableCell>
                 ...
                 <TableBody>
                   {rows.map((row) => (
                      ...
                      >
                          ...
                          <TableCell sx={{color:'#828282'}} align="center">{row.Ds}</TableCell>
